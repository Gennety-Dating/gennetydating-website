        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-16">
          ...
          <div className="flex flex-col items-start md:items-end gap-4">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-magenta animate-pulse-glow" />
              <span className="text-xs uppercase tracking-widest text-magenta font-semibold drop-shadow-neon-sm">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="relative select-none">
                <div className="flex items-center gap-3 bg-black/60 border border-white/10 rounded-xl px-4 py-2 opacity-60">
                  ...
                  <div className="text-left leading-tight">
                    <span className="block text-[8px] uppercase tracking-wider text-gray-400 font-medium">Download on the</span>
                    <span className="block text-sm font-semibold text-white">App Store</span>
                  </div>
                </div>
                {/* Soon sticker overlay */}
                <span className="absolute -top-2 -right-3 z-10 px-2 py-0.5 text-[9px] font-bold tracking-widest text-black bg-magenta rounded-md rotate-12 uppercase shadow-[0_0_10px_rgba(255,0,255,0.8)] border border-white/20">
                  soon
                </span>
              </div>
              ...
              <div className="relative select-none">
                <div className="flex items-center gap-3 bg-black/60 border border-white/10 rounded-xl px-4 py-2 opacity-60">
                  ...
                  <div className="text-left leading-tight">
                    <span className="block text-[8px] uppercase tracking-wider text-gray-400 font-medium">Get it on</span>
