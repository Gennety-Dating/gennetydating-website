            ...
            >
              ...
              <div className="h-40 flex items-center justify-center relative mb-6 w-full">
                ...
                {num === 2 && (
                  ...
                  <div className="relative w-24 h-24 rounded-full bg-midnight flex items-center justify-center shadow-[inset_0_0_20px_rgba(139,37,59,0.1)] group-hover:shadow-[inset_0_0_30px_rgba(139,37,59,0.2)] transition-all duration-500">
                    <div className="w-3.5 h-3.5 rounded-full bg-magenta shadow-[0_0_15px_rgba(139,37,59,1)] group-hover:scale-125 transition-transform duration-500" />
                  </div>
                )}
                ...
                {num === 3 && (
                  ...
                  <div className="relative flex flex-col items-center">
                    <div className="transition-transform duration-500 group-hover:-translate-y-2">
                      <svg className="w-14 h-14 text-magenta drop-shadow-[0_0_12px_rgba(139,37,59,0.4)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                        <path d="M12 2C8.13 2 5 5.13 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.13 15.87 2 12 2Z" fill="rgba(139,37,59,0.02)" />
