    ...
    <section className="py-[120px] px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="relative w-full max-w-lg">
            <div className="rounded-xl bg-gradient-to-br from-stone-800/80 to-stone-900/60 border border-white/10 p-6 relative overflow-hidden h-[200px] flex flex-col justify-center">
              {/* Graph paper lines */}
              <div
