    ...
    <section className="relative flex flex-col items-center justify-center min-h-screen pt-24 pb-16 px-4 text-center overflow-hidden">
      ...
      <div className="relative mt-8 inline-block">
        <Button
          ...
          className="pl-[27px]"
        >
          <svg className="w-[22px] h-[22px] shrink-0 relative -left-[6px] top-[1px]" viewBox="35 65 145 135" fill="currentColor" aria-hidden="true">
            <path d="M54.7 118.6c34.9-15.2 58.2-25.2 69.8-30.1 33.2-13.8 40.1-16.2 44.6-16.3 1 0 3.2.2 4.7 1.4 1.2 1 1.5 2.3 1.7 3.3.2 1 .4 3.2.2 4.9-1.8 19-9.7 65.1-13.7 86.4-1.7 9-5 12-8.3 12.3-7 .6-12.4-4.6-19.2-9.1-10.7-7-16.8-11.3-27.2-18.2-12-7.9-4.2-12.3 2.6-19.4 1.8-1.9 32.8-30 33.4-32.6.1-.3.1-1.5-.6-2.1-.7-.6-1.7-.4-2.5-.2-1.1.2-18.1 11.5-51.2 33.9-4.8 3.3-9.2 4.9-13.2 4.8-4.3-.1-12.7-2.5-18.9-4.5-7.6-2.5-13.7-3.8-13.2-8 .3-2.2 3.3-4.5 9-6.7Z"/>
          </svg>
