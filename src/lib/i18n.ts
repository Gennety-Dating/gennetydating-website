...
export const translations = {
  en: {
    ...
    // Countdown
    "countdown.nextMatch": "Next Match Drop:",
    ...
    "step.1.desc": "Fill out your profile and specify your preferences.",
    "step.2.title": "Daily Match Drop",
    "step.2.desc":
    ...
    "matchmaker.subheadline": "Chat with your agent every day and boost your chances of getting a more relevant match.",
  ...
  uk: {
    ...
    // Countdown
    "countdown.nextMatch": "До наступного дропу:",
    ...
    "step.1.title": "Розкажи Gennety свій типаж",
    "step.1.desc": "Заповни свою анкету та вкажи свої вподобання.",
    "step.2.title": "Щоденний дроп",
    "step.2.desc":
      "Перевіряй Telegram кожен день о 19:00.",
    ...
    "difference.doThis": "Використовуй це",
    ...
    "difference.chat.msg5.upgraded": "Аналізую анкети NYU 24/7... Оброблено 3 840 кандидатів для ідеального метчу. 🧠",
    ...
    "matchmaker.subheadline": "Спілкуйся зі своїм агентом кожен день та збільшуй шанс на більш релевантний match.",
  ...
  ru: {
    ...
    // Countdown
    "countdown.nextMatch": "До следующего дропа:",
    ...
    "step.1.title": "Расскажи Gennety свой типаж",
    "step.1.desc": "Заполни свою анкету и укажи свои предпочтения.",
    "step.2.title": "Ежедневный дроп",
    "step.2.desc":
      "Проверяй Telegram каждый день в 19:00.",
    ...
    "difference.doThis": "Используй это",
    ...
    "difference.tinder.man2.college": "Columbia",
    "difference.tinder.man3.name": "Влад, 20",
    "difference.tinder.man3.bio": "Всегда за спортзал, теннис или спонтанную поездку на выходные",
    "difference.tinder.man3.college": "NYU",
    ...
    "difference.tinder.man6.bio": "Книги, раннее утро в парке и поиск кого-то, с кем можно поспорить о философии.",
    "difference.tinder.man6.college": "NYU",
    ...
    "matchmaker.subheadline": "Общайся со своим агентом каждый день и увеличивай шанс на более релевантный match.",
  ...
  de: {
    ...
    "hero.disclaimer": "Mit dem Fortfahren akzeptierst du unsere",
    "hero.terms": "AGB",
    "hero.privacy": "Datenschutz",

    // Countdown
    "countdown.nextMatch": "Nächster Match-Drop:",
    ...
    "step.1.desc": "Fülle dein Profil aus und gib deine Vorlieben an.",
    "step.2.title": "Täglicher Match-Drop",
    "step.2.desc":
      "Überprüfe dein Telegram jeden Tag um 19:00 Uhr.",
    ...
    "difference.insteadOfThis": "Stattdessen",
    "difference.doThis": "Nutz das",
    ...
    "matchmaker.subheadline": "Chatte jeden Tag mit deinem Agenten und erhöhe deine Chancen auf ein relevanteres Match.",
  ...
  pl: {
    ...
    // Countdown
    "countdown.nextMatch": "Do następnego dropu:",
    ...
    "step.1.desc": "Wypełnij swój profil i określ swoje preferencje.",
    "step.2.title": "Codzienny Drop",
    "step.2.desc":
      "Sprawdzaj swój Telegram codziennie o 19:00.",
    ...
    "matchmaker.subheadline": "Rozmawiaj ze swoim agentem każdego dnia i zwiększaj szanse na bardziej dopasowane match.",
    ...
    "thesis.p4": "Wszyscy rozumiemy, że podczas osobistego spotkania widzisz emocje człowieka, jego reakcje, zachowanie, gestykulację — tę ogromną liczbę sygnałów, które pozwalają podjąć decyzję. Tego wszystkiego nie ma na czacie.",
    ...
    "thesis.p12": "Owszem, styl życia i ogólne tempo życia wielu ludzi uległy zmianie. Wraz z przeprowadzką do dużych miast i metropolii ludzie mają coraz mniej czasu na życie osobiste: pracujemy coraz więcej i mamy coraz mniej czasu na zajmowanie się tym niekończącym się poszukiwaniem.",
  ...
  fr: {
    ...
    // Countdown
    "countdown.nextMatch": "Prochain drop de matchs :",
    ...
    "step.1.desc": "Remplis ton profil et indique tes préférences.",
    "step.2.title": "Drop quotidien",
    "step.2.desc": "Vérifie ton Telegram chaque jour à 19h.",
    ...
    "difference.doThis": "Utilise ceci",
    ...
    "matchmaker.subheadline": "Discute avec ton agent chaque jour et augmente tes chances d'obtenir un match plus pertinent.",
    ...
    "matchmaker.2.title": "Gennety apprend vos préférences",
    ...
    "thesis.p11": "Aujourd'hui, les gens trouvent des solutions auprès d'entremetteurs personnels, ou matchmakers professionnels. Mais tout le monde ne peut pas se le permettre, et cela présente ses propres inconvénients.",
  ...
  it: {
    ...
    // Countdown
    "countdown.nextMatch": "Prossimo drop di match:",
    ...
    "step.1.desc": "Compila il tuo profilo e indica le tue preferenze.",
    "step.2.title": "Drop giornaliero",
    "step.2.desc": "Controlla il tuo Telegram ogni giorno alle 19:00.",
    ...
    "matchmaker.subheadline": "Chatta con il tuo agente ogni giorno e aumenta le tue possibilità di ottenere un match più pertinente.",
    ...
    "faq.2.a": "Gennety organizza appuntamenti per te senza richiedere che tu faccia swipe o chatti con qualcuno. Dopo aver inviato le tue informazioni, Gennety ti invierà un messaggio con il piano dell'appuntamento che include ora, luogo e dettagli del tuo match. L'appuntamento si terrà nei pressi del campus vicino a te.",
  ...
  es: {
    ...
    // Countdown
    "countdown.nextMatch": "Próximo drop de matches:",
    ...
    "step.1.desc": "Rellena tu perfil e indica tus preferencias.",
    "step.2.title": "Drop diario",
    "step.2.desc": "Revisa tu Telegram todos los días a las 19:00.",
    ...
    "matchmaker.subheadline": "Chatea con tu agente todos los días y aumenta tus posibilidades de obtener un match más relevante.",
    ...
    "safety.3.desc": "Todas las citas se realizan en lugares verificados, concurridos y seguros.",
    ...
    "thesis.p10": "Como resultado de este comportamiento, las mujeres actúan con más cautela y se vuelven muy selectivas. Esto obliga a los hombres a ser aún más persistentes para maximizar sus posibilidades, y este bucle solo se refuerza a sí mismo, destacando una vez más los defectos de las mecánicas actuales en las aplicaciones de citas. Con el simple hecho de eliminar el chat y la capacidad de examinar miles de perfiles al día, y limitando esto a través de las mecánicas principales de la aplicación, ya nos libramos de la mayoría de los problemas principales.",
    "thesis.p11": "Hoy en día, las personas encuentran soluciones en matchmakers personales o profesionales. Pero no todo el mundo puede permitírselo, y tienen sus propios inconvenientes.",
