...
export const translations = {
  ...
  ru: {
    ...
    "thesis.p1": "Уже давно рынок дейтинга требовал нашего пересмотра. У каждого человека есть потребность в романтических отношениях, технологии за все то время, что нам довелось изучить, в основном помогали людям преимущественно только в том, где для них было больше всего различных барьеров и преград по различным причинам. Этим узким местом всегда был первый контакт, и все игроки этого рынка всегда старались его облегчить, упростить, переведя его в онлайн. Мыслить в этом направлении — это правильно, но форма, в которую обычно оборачивался этот первый контакт, как будто какая-то проклятая и сегодня встречается почти везде.",
    "thesis.p2": "Разные приложения дифференцировались в основном только через аудиторию: приложения для серьезных отношений, для коротких интрижек, для полных, для худых, для ЛГБТ-сообщества, локальные для конкретных стран и так далее. Но принцип всегда оставался один: ты сидишь перед экраном и перебираешь анкеты, сотни анкет. Чтобы пойти на одно свидание обычному человеку, используя современные приложения для знакомств, в среднем требуется 9500 свайпов, что эквивалентно 9500 анкет — это непростительно много и, кроме того, занимает чудовищно много времени. А ведь вы не забывайте, что перебрать с десяток тысяч анкет — это еще не конец.",
    "thesis.list.title": "Нужно:",
    "thesis.list.item1": "1. Дождаться ответной симпатии.",
    "thesis.list.item2": "2. Не оборвать контакт на первом сообщении в чате, которые обычно или очень глупые, или страшно шаблонные.",
    "thesis.list.item3": "3. Не стать жертвой мошенничества или фейка, что сегодня сплошь и рядом в этих приложениях.",
    "thesis.list.item4": "4. Ну и наконец, завязать нормальный диалог в чате. Такие переписки обычно бывают довольно продолжительными и редко когда перерастают в реальную встречу.",
    "thesis.p4": "Все мы понимаем, что при личной встрече ты видишь эмоции человека, его реакции, поведение, жестикуляцию — то огромное количество сигналов, которые дают возможность принять решение. Всего этого нет в чате.",
    "thesis.p5": "К тому же наличие чата дает больше возможностей мошенникам. Сегодня это целая индустрия, и большим каналом трафика для нее являются как раз дейтинг-приложения.",
    "thesis.p6": "Поэтому большой вопрос: является ли чат необходимость в подобных приложениях? Ведь раньше люди знакомились на улицах, их первый контакт происходил гораздо быстрее, и обратную связь они получали мгновенно. Сегодня же эта обратная связь затягивается на недели, а то и месяцы.",
    "thesis.p7": "Есть также большая проблема, которая связана со скам-рынком. Например: только в 2025 году мужское население в США потеряло 400 000 000 долларов внутри приложений для знакомств. То же самое произошло в Великобритании, где размер ущерба составил 105 000 000 рублей (опять же, только среди мужчин и только в дейтинг-сервисах).",
    "thesis.p8": "Наверное, один из главных недостатков дейтинг-индустрии сегодня и на протяжении многих лет — это неравное распределение пользователей по половому признаку внутри сервисов. Этот демографический перекос между женщинами и мужчинами оставался в последние годы самой острой проблемой, которую пытались решить, например, выходцы из Tinder.",
    "thesis.p9": "Самый яркий кейс — основательница Bumble, второго по капитализации холдинга, который сегодня содержит в портфеле несколько крупных приложений для знакомств, таких как Bumble, Badoo и ряд других. Эта проблема продиктована в большинстве своем, в первую очередь, нашей природой и, во вторую очередь, механиками, которые зашиты в существующие приложения. Мужчины склонны к более активной и настойчивой стратегии: они лайкают примерно в 6 раз чаще, чем девушки, чаще пишут и проводят на сервисе больше времени.",
    "thesis.p10": "Девушки вследствие такого поведения ведут себя аккуратнее и становятся более переборчивыми. Отчего мужчины вынуждены быть еще более настойчивыми, чтобы максимизировать свои шансы, и эта петля только усиливается, что еще раз показывает нам несовершенство текущих механик в дейтинг-приложениях. Ведь просто исключив чат и возможность перебирать по тысяче анкет в день, ограничив это механиками приложения, мы уже избавляемся от большинства главных проблем.",
    "thesis.p11": "Сегодня люди находят решения в личных матчмейкерах, или как их еще называют — профессиональных свахах. Но не каждый может их себе позволить, да и у них тоже есть свои минусы.",
    "thesis.p12": "Да, уклад жизни и в целом ритм жизни многих людей поменялся. С переездом в большие города и мегаполисы у людей все меньше времени на личную жизнь: мы все больше работаем, и у нас остается все меньше времени на то, чтобы занимать себя этим бесконечным поиском.",
    "thesis.p13": "Поэтому мы однозначно видим все эти проблемы: большое количество фейков, мошенничество, выгорание и усталость от бесконечного свайпинга и скроллинга анкет, а также низкую эффективность и конверсию в свидания.",
    "thesis.p14": "С сегодняшними технологиями, привычкой людей предоставлять свои личные данные и информацию для усовершенствования своего цифрового опыта и уже устоявшимся ожиданием персонализированного сервиса, просто удивительно, что рынок дейтинга так долго оставался без внимания.",
